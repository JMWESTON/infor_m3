...
public class GET extends ExtendM3Transaction {
	...
	public void main() {
		...
		DBAction ext008Record = database.table("EXT008").index("00").selection("EXPLGR","EXSTYL","EXITDS","EXTYPE","EXNBOF","EXPRIO","EXSORT").build();
		...
		if(ext008Record.read(ext008Container)){
			...
			mi.getOutData().put("PLGR", ext008Container.getString("EXPLGR"));
